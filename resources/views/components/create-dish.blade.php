<form class="w-full" method="POST" action="{{ route('dishes.store') }}"  enctype="multipart/form-data">
    @csrf
    <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full md:w-1/2 px-3">
            ...
            name="name" id="grid-last-name" type="text" placeholder="{{ __('Name') }}" required>
        </div>
        <div class="w-full md:w-1/2 px-3">
        ...
        <div class="w-full px-3 mt-3"> 
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                ...
                name="description" rows="5" placeholder="{{ __('Enter description here')}}" required></textarea>
            </label>
        </div>
        ...
        <div class="w-full md:w-1/2 px-3 mt-3" id="ingredient_input">
            ...
            <div class="flex">
                ...
                name="ingredients[]" id="grid-last-name" type="text" placeholder="{{ __('Add Ingredient') }}" required>
        ...
        <div class="w-full md:w-1/2 px-3 mt-3" id="preparation_steps_input">
            ...
            <div class="flex">
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 md:w-5/6"
                name="preparation_steps[]" id="grid-last-name" type="text" placeholder="{{ __('Add Step') }}" required>
